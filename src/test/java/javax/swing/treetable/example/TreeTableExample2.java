package javax.swing.treetable.example;
...
public class TreeTableExample2 {
	...
	treeTable.getTreeRenderer().addTreeExpansionListener(rl);
	return treeTable;
    }
	...
	menuItem.addActionListener(new ActionListener() {
	    public void actionPerformed(ActionEvent ae) {
		TreePath         path = treeTable.getTreeRenderer().getSelectionPath();
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if (newPath == null) {
		    ...
		    int        newRow = treeTable.getTreeRenderer().getRowForPath
			                          (newPath);
	...
	protected void updateRow() {
	    ...
	    if (reloadPath != null) {
		reloadRow = treeTable.getTreeRenderer().getRowForPath(reloadPath);
	    }
	}
    }
