...
public class JTreeTable extends JTable {
    ...
    public JTreeTable(TreeTableModel model) {
        ...
        */
        ...
        // the table.
        if (!tree.isFixedRowHeight()) { // Metal looks better like this.
        // if (tree.getRowHeight() < 1) {
            
            // By default, JTree.rowHeight is 16
            //    + 2 for borders ???
            setRowHeight(18);
        }
    }
     ...
     */
    public TreeTableCellRenderer getTreeRenderer() {
        return tree;
    }
    ...
    public void setTreeTableModel(TreeTableModel model) {
        ...
        if (treeTableModel != model) {
            treeTableModel = model;
            
            // Create the tree. It will be used as a renderer and editor.
            tree = createTreeTableCellRenderer(model);
            
            // Install a tableModel representing the visible rows in the tree. 
            super.setModel(new TreeTableModelAdapter(model, tree));

            // Force the JTable and JTree to share their row selection models.
            selectionWrapper.resetRowSelection();
    ...
    protected TreeTableCellRenderer createTreeTableCellRenderer(TreeTableModel model) {
    ...
    TableCellEditor {
         ...
         * 
         * Note: On toggle selection, this causes a click to be handled twice !!
         *  
         */
                ...
                for (int counter = getColumnCount() - 1; counter >= 0; counter--) {
                    if (getColumnClass(counter) == TreeTableModel.class) {
                        ...
                        System.out.println("Modifier : "
                                + MouseEvent.getModifiersExText(me.getModifiersEx()));
                        */
                        // Following code comes from BasicTreeUI
                        boolean isToggleSelectionEvent = SwingUtilities.isLeftMouseButton(me)
                                && me.isControlDown();
                        
                        if (isToggleSelectionEvent) 
                        	// Toggle Selection is handled by the parent table 
                            break;
