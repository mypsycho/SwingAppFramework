...
public interface TaskListener<T, V> {
     ...
     * @see TaskEvent#getValue
     */
    void succeeded(TaskEvent<? extends T> event);
     ...
     * @see TaskEvent#getValue
     */
    void failed(TaskEvent<? extends Throwable> event);
     ...
     * @see TaskEvent#getValue
     */
    void interrupted(TaskEvent<? extends InterruptedException> event);
    ...
    class Adapter<T, V> implements TaskListener<T, V> {
        ...
        public void failed(TaskEvent<? extends Throwable> event) {
        }

        public void cancelled(TaskEvent<Void> event) {
        }

        public void interrupted(TaskEvent<? extends InterruptedException> event) {
        }
