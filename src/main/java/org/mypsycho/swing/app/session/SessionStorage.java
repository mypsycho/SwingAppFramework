...
public class SessionStorage {
     ...
     */
    public SessionStorage(ApplicationContext context) {
        if (context == null) {
    ...
    protected void log(String message) {
        // Component location is usually not critical
        log(Level.CONFIG, message, null);
    }

    protected void log(Level lvl, String message, Throwable detail) {
        getApplication().exceptionThrown(lvl, "sessionStorage", message, detail);
    }
        ...
        while ((c.getParent() != null) && !(c instanceof Window) && !(c instanceof Applet)) {
            ...
            if (name == null) {
                ...
                if (n >= 0) {
                    ...
                    log("Couldn't compute pathname for " + c);
                    return null;
                }
            }
